...
with zipfile.ZipFile("data.csv.zip", "r") as zip_ref:
    zip_ref.extract("data.csv", "extracted_files")  # Extract to a folder named 'extracted_files'

# Read the extracted file
spotify_data = pd.read_csv("extracted_files/data.csv") ####

#spotify_data = pd.read_csv("data.csv.zip", compression="zip", usecols=None)  # Replace with actual preloaded DataFrame
